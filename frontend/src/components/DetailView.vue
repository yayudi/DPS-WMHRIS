...
function getStatusText(status) {
  switch (status) {
    case 1: return "Tidak Hadir";
    case 2: return "Libur";
    case 3: return "Data Tidak Lengkap";
    default: return "";
  }
}
...
<template>
  ...
  <div class="overflow-x-auto max-h-[75vh] border border-secondary/30 rounded-lg shadow-sm bg-background">
    <table class="min-w-full bg-background text-sm text-text border-collapse">
      ...
      <tbody class="divide-y divide-secondary">
        ...
        >
          ...
          <td class="px-4 py-2">
            <span :class="{ 'text-accent': row.ket === 'Tidak Hadir' || row.ket === 'Data Tidak Lengkap' }">
              {{ row.ket }}
            </span>
          </td>
        </tr>
