<!-- frontend/src/components/products/BatchEditModal.vue -->
<script setup>
...
const handleExport = () => {
  ...
  // Optional: Auto-switch to import tab after export starts?
...
<template>
  ...
  >
    ...
    >
      <!-- SIDEBAR -->
      <div class="w-full md:w-1/3 bg-[hsl(var(--color-secondary))/0.05] p-6 border-r border-[hsl(var(--color-secondary))/0.1]">
        ...
        <div class="mt-8 text-xs opacity-60 leading-relaxed">
          ...
          <ol class="list-decimal list-inside space-y-1">
            <li>Download data produk terkini.</li>
            <li>Edit file Excel/CSV di komputer Anda.</li>
            <li>Upload kembali untuk update otomatis.</li>
          </ol>
        </div>
      </div>
      ...
      <div class="w-full md:w-2/3 p-6 relative flex flex-col">
        ...
        <div v-if="activeTab === 'export'" class="flex-1 flex flex-col">
          <h4 class="text-lg font-bold mb-1">Download Data Produk</h4>
          <p class="text-sm opacity-60 mb-6">Pilih format file untuk diedit.</p>
          ...
          <div class="grid grid-cols-2 gap-4 mb-6">
            ...
            >
              ...
              <div>
                ...
                <div class="text-xs opacity-60">Direkomendasikan</div>
              </div>
            </label>
            ...
            >
              ...
              <div>
                ...
                <div class="text-xs opacity-60">Universal</div>
              </div>
            </label>
          </div>
          ...
          <div class="mt-auto">
            ...
            <p class="text-xs text-center mt-3 opacity-50">File akan berisi semua produk sesuai filter yang aktif.</p>
          </div>
        </div>

        <!-- STEP 2: IMPORT -->
        <div v-if="activeTab === 'import'" class="flex-1 flex flex-col">
          <h4 class="text-lg font-bold mb-1">Upload Revisi</h4>
          <p class="text-sm opacity-60 mb-6">Upload file yang sudah diedit untuk menerapkan perubahan.</p>
          ...
          >
            ...
            <div v-if="selectedFile" class="z-10">
              ...
              />
               ...
               <div class="mt-4 px-3 py-1 bg-[hsl(var(--color-background))] rounded-full text-xs border inline-block">Klik untuk ganti</div>
            </div>
          ...
          >
            ...
            <label class="text-sm cursor-pointer select-none flex-1">
              Test Import (Dry Run) <span class="opacity-50 ml-1">- Cek error tanpa simpan</span>
            </label>
          </div>
          ...
          <button
            ...
            class="w-full px-5 py-3 bg-[hsl(var(--color-primary))] text-white rounded-xl font-bold hover:bg-[hsl(var(--color-primary))/0.9] disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-[hsl(var(--color-primary))/0.3] flex justify-center items-center gap-2 transition-all"
          >
            <font-awesome-icon v-if="isImporting" icon="fa-solid fa-spinner" spin />
            <span>{{ isImporting ? 'Mengunggah...' : 'Terapkan Perubahan' }}</span>
          </button>
        </div>
