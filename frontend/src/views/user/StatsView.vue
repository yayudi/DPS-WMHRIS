  ...
  <div class="p-6 animate-fade-in text-text">
    ...
    <div class="flex flex-col md:flex-row gap-6">
          ...
          >
            ...
            <div class="space-y-1">
              <a
                ...
                class="flex items-center px-3 py-2 text-sm font-medium rounded-lg transition-all"
                :class="
                  activeReport === item.key
                    ? 'bg-primary/10 text-primary shadow-sm'
                    : 'text-text/70 hover:bg-secondary/10 hover:text-text'
                "
              >
      ...
      <main class="w-full md:w-3/4 lg:w-4/5">
        <div
          class="bg-background rounded-xl shadow-md border border-secondary/20 p-6 min-h-[500px] relative overflow-hidden"
        >
          ...
          <div v-else-if="activeReport === 'export-stock'" class="animate-fade-in">
            ...
            <div class="grid lg:grid-cols-3 gap-8">
              ...
              <div class="lg:col-span-2">
                ...
                <div
                  class="bg-background border border-secondary/20 rounded-xl overflow-hidden shadow-sm"
                >
