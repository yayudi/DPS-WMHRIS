...
import (
	...
	"github.com/dps-wmhris/backend/internal/modules/hris/model"
...
type attendanceServiceImpl struct {
	attendanceRepo hris_repo.AttendanceRepository
	userRepo       iam_repo.UserRepository
	shiftRepo      hris_repo.ShiftRepository
	scheduleRepo   hris_repo.ScheduleRepository
	settingRepo    global_repo.SettingRepository
}

func NewAttendanceService(attendanceRepo hris_repo.AttendanceRepository, userRepo iam_repo.UserRepository, shiftRepo hris_repo.ShiftRepository, scheduleRepo hris_repo.ScheduleRepository, settingRepo global_repo.SettingRepository) AttendanceService {
