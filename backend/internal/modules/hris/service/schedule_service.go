...
type scheduleServiceImpl struct {
	...
	userRepo     iam_repo.UserRepository // Assuming we have UserRepository available (we need to inject it)
}

func NewScheduleService(scheduleRepo hris_repo.ScheduleRepository, shiftRepo hris_repo.ShiftRepository, userRepo iam_repo.UserRepository) ScheduleService {
