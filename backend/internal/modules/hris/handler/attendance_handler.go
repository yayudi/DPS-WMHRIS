...
type AttendanceHandler struct {
	attendanceService hris_service.AttendanceService
	jobService        service.JobService
}

func NewAttendanceHandler(attendanceService hris_service.AttendanceService, jobService service.JobService) *AttendanceHandler {
