...
type ScheduleHandler struct {
	scheduleService hris_service.ScheduleService
	jobService      service.JobService
}

func NewScheduleHandler(scheduleService hris_service.ScheduleService, jobService service.JobService) *ScheduleHandler {
