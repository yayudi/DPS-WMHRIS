...
type JobRepository interface {
	// Import Jobs
	CreateImportJob(ctx context.Context, job *system_domain.ImportJob) (int, error)
	GetImportJobs(ctx context.Context, page int, limit int) (utils.PaginatedResult[system_domain.ImportJob], error)
	GetImportJobByID(ctx context.Context, id int) (*system_domain.ImportJob, error)
	...
	GetPendingImportJobs(ctx context.Context) ([]system_domain.ImportJob, error)
	ClaimNextImportJob(ctx context.Context) (*system_domain.ImportJob, error)
	RecoverStuckImportJobs(ctx context.Context) (int, error)

	// Export Jobs
	CreateExportJob(ctx context.Context, job *system_domain.ExportJob) (int, error)
	GetExportJobs(ctx context.Context, page int, limit int) (utils.PaginatedResult[system_domain.ExportJob], error)
	GetExportJobByID(ctx context.Context, id int) (*system_domain.ExportJob, error)
	UpdateExportJobStatus(ctx context.Context, id int, status string, filePath *string, errorMessage *string) error
	GetPendingExportJobs(ctx context.Context) ([]system_domain.ExportJob, error)
	ClaimNextExportJob(ctx context.Context) (*system_domain.ExportJob, error)
...
func (r *jobRepositoryImpl) GetImportJobs(ctx context.Context, page int, limit int) (utils.PaginatedResult[system_domain.ImportJob], error) {
	query := `SELECT * FROM import_jobs ORDER BY created_at DESC`
	return utils.FetchPaginated[system_domain.ImportJob](ctx, r.db, query, page, limit)
}

func (r *jobRepositoryImpl) GetImportJobByID(ctx context.Context, id int) (*system_domain.ImportJob, error) {
	query := `SELECT * FROM import_jobs WHERE id = ?`
	var job system_domain.ImportJob
...
func (r *jobRepositoryImpl) GetPendingImportJobs(ctx context.Context) ([]system_domain.ImportJob, error) {
	query := `SELECT * FROM import_jobs WHERE status IN ('PENDING', 'PROCESSING') ORDER BY created_at ASC`
	var jobs []system_domain.ImportJob
	err := r.db.SelectContext(ctx, &jobs, query)
	return jobs, err
}

func (r *jobRepositoryImpl) ClaimNextImportJob(ctx context.Context) (*system_domain.ImportJob, error) {
	var job system_domain.ImportJob
	...
	err := ext.GetContext(ctx, &job, query)
	if err != nil {
		return nil, err
	}
...
func (r *jobRepositoryImpl) CreateExportJob(ctx context.Context, job *system_domain.ExportJob) (int, error) {
	query := `
...
func (r *jobRepositoryImpl) GetExportJobs(ctx context.Context, page int, limit int) (utils.PaginatedResult[system_domain.ExportJob], error) {
	query := `SELECT * FROM export_jobs ORDER BY created_at DESC`
	return utils.FetchPaginated[system_domain.ExportJob](ctx, r.db, query, page, limit)
}

func (r *jobRepositoryImpl) GetExportJobByID(ctx context.Context, id int) (*system_domain.ExportJob, error) {
	query := `SELECT * FROM export_jobs WHERE id = ?`
	var job system_domain.ExportJob
	err := r.db.GetContext(ctx, &job, query, id)
	return &job, err
}
...
func (r *jobRepositoryImpl) GetPendingExportJobs(ctx context.Context) ([]system_domain.ExportJob, error) {
	query := `SELECT * FROM export_jobs WHERE status = 'PENDING' ORDER BY created_at ASC`
	var jobs []system_domain.ExportJob
	err := r.db.SelectContext(ctx, &jobs, query)
	return jobs, err
}

func (r *jobRepositoryImpl) ClaimNextExportJob(ctx context.Context) (*system_domain.ExportJob, error) {
	var job system_domain.ExportJob
