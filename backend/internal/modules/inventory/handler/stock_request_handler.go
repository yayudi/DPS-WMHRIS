...
type StockRequestHandler struct {
	stockRequestService inventory_service.StockRequestService
}

func NewStockRequestHandler(stockRequestService inventory_service.StockRequestService) *StockRequestHandler {
