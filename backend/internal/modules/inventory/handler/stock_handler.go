...
type StockHandler struct {
	stockService inventory_service.StockService
	jobService   global_service.JobService
}

func NewStockHandler(stockService inventory_service.StockService, jobService global_service.JobService) *StockHandler {
	return &StockHandler{
