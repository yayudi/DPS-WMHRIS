...
type PickingHandler struct {
	...
	pickingService inventory_service.PickingService
}

func NewPickingHandler(jobService global_service.JobService, pickingService inventory_service.PickingService) *PickingHandler {
