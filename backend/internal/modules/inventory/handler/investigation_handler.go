...
type InvestigationHandler struct {
	investigationService inventory_service.InvestigationService
}

func NewInvestigationHandler(investigationService inventory_service.InvestigationService) *InvestigationHandler {
