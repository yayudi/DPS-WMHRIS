...
type StockRepository interface {
	GetStockByLocation(ctx context.Context, db sqlx.ExtContext, productID int, locationID int) (*inventory_model.StockLocation, error)
	UpsertStockLocation(ctx context.Context, db sqlx.ExtContext, stock *inventory_model.StockLocation) error
	RecordMovement(ctx context.Context, db sqlx.ExtContext, movement *inventory_model.StockMovement) error
...
func (r *stockRepositoryImpl) GetStockByLocation(ctx context.Context, db sqlx.ExtContext, productID int, locationID int) (*inventory_model.StockLocation, error) {
	var stock inventory_model.StockLocation
...
func (r *stockRepositoryImpl) UpsertStockLocation(ctx context.Context, db sqlx.ExtContext, stock *inventory_model.StockLocation) error {
	query := `
...
func (r *stockRepositoryImpl) RecordMovement(ctx context.Context, db sqlx.ExtContext, movement *inventory_model.StockMovement) error {
	query := `
