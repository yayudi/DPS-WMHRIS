...
type LocationRepository interface {
	database.BaseRepository[inventory_model.Location]
	Create(ctx context.Context, location *inventory_model.Location) error
	Update(ctx context.Context, tx *sqlx.Tx, location *inventory_model.Location) error
...
func (r *locationRepositoryImpl) Update(ctx context.Context, tx *sqlx.Tx, location *inventory_model.Location) error {
	query := `
		UPDATE locations 
...
func (r *locationRepositoryImpl) Create(ctx context.Context, location *inventory_model.Location) error {
	query := `
...
func NewLocationRepository(db *sqlx.DB) LocationRepository {
	base := database.NewBaseRepository[inventory_model.Location](db, "locations")
