...
type PickingRepository interface {
	...
	GetHeaderByID(ctx context.Context, tx *sqlx.Tx, id int) (*inventory_model.PickingList, error)
	GetItemsByIDs(ctx context.Context, tx *sqlx.Tx, itemIDs []int) ([]inventory_model.PickingListItem, error)
	...
	CreatePickingListTx(ctx context.Context, tx *sqlx.Tx, header *inventory_model.PickingList) (int, error)
	CreatePickingListItemTx(ctx context.Context, tx *sqlx.Tx, item *inventory_model.PickingListItem) error

	GetItemsToRestock(ctx context.Context, tx *sqlx.Tx, listID int) ([]inventory_model.PickingListItem, error)
	GetUnfulfillableItems(ctx context.Context, tx *sqlx.Tx, listID int) ([]inventory_model.PickingListItem, error)
	GetPendingAndBackorderItems(ctx context.Context, tx *sqlx.Tx, listIDs []int) ([]inventory_model.PickingListItem, error)
}
...
func (r *pickingRepository) GetHeaderByID(ctx context.Context, tx *sqlx.Tx, id int) (*inventory_model.PickingList, error) {
	query := `SELECT * FROM picking_lists WHERE id = ? LIMIT 1`
	var header inventory_model.PickingList
	var err error
	if tx != nil {
...
func (r *pickingRepository) GetItemsByIDs(ctx context.Context, tx *sqlx.Tx, itemIDs []int) ([]inventory_model.PickingListItem, error) {
	if len(itemIDs) == 0 {
		return []inventory_model.PickingListItem{}, nil
	}
	...
	var items []inventory_model.PickingListItem
...
func (r *pickingRepository) GetItemsToRestock(ctx context.Context, tx *sqlx.Tx, listID int) ([]inventory_model.PickingListItem, error) {
	query := `
...
func (r *pickingRepository) GetUnfulfillableItems(ctx context.Context, tx *sqlx.Tx, listID int) ([]inventory_model.PickingListItem, error) {
	query := `
...
func (r *pickingRepository) GetPendingAndBackorderItems(ctx context.Context, tx *sqlx.Tx, listIDs []int) ([]inventory_model.PickingListItem, error) {
	if len(listIDs) == 0 {
		return []inventory_model.PickingListItem{}, nil
	}
...
func (r *pickingRepository) CreatePickingListTx(ctx context.Context, tx *sqlx.Tx, header *inventory_model.PickingList) (int, error) {
	query := `
...
func (r *pickingRepository) CreatePickingListItemTx(ctx context.Context, tx *sqlx.Tx, item *inventory_model.PickingListItem) error {
	query := `
