...
type ReturnRepository interface {
	...
	GetMarketplaceReturnHistory(ctx context.Context, page, limit int, search string) (utils.PaginatedResult[inventory_model.MarketplaceReturnItem], error)
	GetManualReturnHistory(ctx context.Context, page, limit int, search string) (utils.PaginatedResult[inventory_model.ManualReturnItem], error)
	GetPickingItemById(ctx context.Context, db sqlx.ExtContext, id int) (*inventory_model.PickingListItem, error)
	...
	CreateSplitReturnItem(ctx context.Context, db sqlx.ExtContext, originItem *inventory_model.PickingListItem, qtyReturn int, condition string, notes string, locationID int) (int, error)
	CreateManualReturn(ctx context.Context, db sqlx.ExtContext, manualReturn *inventory_model.ManualReturn) error
}
...
func (r *returnRepositoryImpl) GetMarketplaceReturnHistory(ctx context.Context, page, limit int, search string) (utils.PaginatedResult[inventory_model.MarketplaceReturnItem], error) {
	...
	return utils.FetchPaginated[inventory_model.MarketplaceReturnItem](ctx, r.db, query, page, limit, queryParams...)
}

func (r *returnRepositoryImpl) GetManualReturnHistory(ctx context.Context, page, limit int, search string) (utils.PaginatedResult[inventory_model.ManualReturnItem], error) {
	...
	return utils.FetchPaginated[inventory_model.ManualReturnItem](ctx, r.db, query, page, limit, queryParams...)
}

func (r *returnRepositoryImpl) GetPickingItemById(ctx context.Context, db sqlx.ExtContext, id int) (*inventory_model.PickingListItem, error) {
	var item inventory_model.PickingListItem
...
func (r *returnRepositoryImpl) CreateSplitReturnItem(ctx context.Context, db sqlx.ExtContext, originItem *inventory_model.PickingListItem, qtyReturn int, condition string, notes string, locationID int) (int, error) {
	query := `
...
func (r *returnRepositoryImpl) CreateManualReturn(ctx context.Context, db sqlx.ExtContext, manualReturn *inventory_model.ManualReturn) error {
	query := `
