...
type ProductHandler struct {
	productService catalog_service.ProductService
	jobService     global_service.JobService
}

func NewProductHandler(productService catalog_service.ProductService, jobService global_service.JobService) *ProductHandler {
