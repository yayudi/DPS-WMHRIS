...
type ProductRepository interface {
	database.BaseRepository[catalog_model.Product]
	Create(ctx context.Context, db sqlx.ExtContext, product *catalog_model.Product) error
	Update(ctx context.Context, db sqlx.ExtContext, product *catalog_model.Product) error
	GetBySKUs(ctx context.Context, skus []string) ([]catalog_model.Product, error)
...
func NewProductRepository(db *sqlx.DB) ProductRepository {
	base := database.NewBaseRepository[catalog_model.Product](db, "products")
...
func (r *productRepositoryImpl) Create(ctx context.Context, db sqlx.ExtContext, product *catalog_model.Product) error {
	query := `
...
func (r *productRepositoryImpl) Update(ctx context.Context, db sqlx.ExtContext, product *catalog_model.Product) error {
	query := `
		UPDATE products 
...
func (r *productRepositoryImpl) GetBySKUs(ctx context.Context, skus []string) ([]catalog_model.Product, error) {
	if len(skus) == 0 {
		return []catalog_model.Product{}, nil
	}
